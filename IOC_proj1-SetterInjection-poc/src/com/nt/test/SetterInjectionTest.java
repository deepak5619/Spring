...
public class SetterInjectionTest {
	public static void main(String[] args) {
		...
		System.out.println("SetterInjectionTest.main()");//1
		Resource res=null;
		...
		System.out.println("\nSetterInjectionTest.main():before target class object wmg");
		obj=factory.getBean("wmg");                 //4
		System.out.println("SetterInjectionTest.main():After target class object wmg");
